...
#' \code{keyring::key_set("DB_<databaseName>.<schemaName>", username = "Driver={ODBC Driver 17 for SQL Server};Server=<serverName>;Database=<databaseName>;UID=<schemaName>;PWD=<password>;")}\cr
